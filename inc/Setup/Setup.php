...
class Setup {
	...
	public function setup() {
		load_theme_textdomain( 'blenco', get_template_directory() . '/languages' );
	...
	private function add_image_size() {
		$sizes = [
			// 'blenco-size1' => [ 1344, 625, true ],
			// 'blenco-size2'  => [ 960, 520, true ],
			// 'blenco-size3'  => [ 960, 690, true ],
			// 'blenco-size4'  => [ 450, 450, true ],
			// 'blenco-size5'  => [ 600, 682, true ],
			// 'blenco-size6'  => [ 960, 960, true ],
		];

		$sizes = apply_filters( 'blenco_image_size', $sizes );
