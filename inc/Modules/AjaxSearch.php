...
class AjaxSearch{
	...
	public function rt_data_fetch(){
		// Checking nonce.
		check_ajax_referer( 'rt-blenco-nonce', 'security' );
		$args = array(
			'post_type' => 'post',
			'posts_per_page' => 8,
		...
		if( $the_query->have_posts() ) :
			while( $the_query->have_posts() ):
				...
				<div class="rt-search-result-list">
					...
					<ul class="rt-search-breadcrumb">
						...
						$category_dropdown = array(  0 => __( 'All Category', 'blenco' ) );
			...
			<h3 class="rt-no-found"><?php esc_html_e('No Results Found', 'blenco'); ?></h3>
		<?php endif;
		die();
	}
