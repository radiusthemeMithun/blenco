...
class TeamRelated {
	public static function rt_team_related() {
		...
		$related_item_number = blenco_option( 'rt_team_related_limit' );

		# Making ready to the Query ...
		$query_type = blenco_option( 'rt_team_related_query' );
		...
		if( blenco_option( 'rt_team_related_sort' ) ){

			$post_order = blenco_option( 'rt_team_related_sort' );
		...
		if( $related_query->have_posts() && blenco_option( 'rt_team_related' ) ) { ?>
			<div class="rt-team-default rt-team-multi-layout-1 rt-related-team">
				<div class="container">
					<h2 class="related-title"><?php blenco_html( blenco_option( 'rt_team_related_title' ) , 'allow_title' );?></h2>
					<div class="row g-4">
						...
						$related_query->the_post();
							...
							$content = wp_trim_words( get_the_excerpt(), blenco_option( 'rt_team_excerpt_limit' ), '' );

							$shape_svg = blenco_option( 'rt_team_shape_svg' );
							$shape_image  = blenco_option( 'rt_team_shape_image' );
						?>
