;(function ($) {
    ...
    mm.add({
        ...
        if (isDesktop) {
            ...
            // Horizontal Scroll
            $('.rt-project-fun.rt-scale-animation').each(function() {
                let $wrapper = $(this).find('.rt-project-fun-wrap');
                let sections = gsap.utils.toArray($(this).find(".rt-funfact-panel"));
                ...
                if (sections.length > 0) {
                    gsap.to(sections, {
                        ...
                        scrollTrigger: {
                            ...
                            pin: true,
                            scrub: 1,
                            end: () => "+=" + document.querySelector(".rt-project-fun").offsetWidth
                        }
                    });
                }
            });
        ...
        if (isTablet) {
            ...
            if (document.querySelector("#rt_smooth")?.classList.contains("rt-smooth")) {
