...
<head>
	...
	<meta name="description" content="Author: RadiusTheme,
	...
	<div id="header-search" class="header-search">
		<div class="header-search-wrap">
			...
			<form method="get" class="header-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
				<input type="search" value="<?php echo get_search_query(); ?>" name="s" placeholder="<?php esc_attr_e( 'Type your search........', 'blenco' ); ?>">
